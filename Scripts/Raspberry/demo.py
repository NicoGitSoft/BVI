...
MODEL_PATH = os.path.join(MainDir, './Models/YOLOv7Tiny', "yolov7tiny_openvino_2021.4_6shave.blob")
CONFIG_PATH = os.path.join(MainDir, './Models/YOLOv7Tiny', "yolov7tiny.json")
