...
chipTemperature = []  # Muestras de la temperatura del dispositivo
...
while True:
    ...
    if (current_time - frames_timer) > 1:
        chipTemperature.append(qSysInfo.get().chipTemperature.average)
...
with open('data.csv', 'w', newline='') as file:
    ...
    writer.writerow(["times", "z", "d", "h", "v", "nearest_labels", "haptic_messages", "buzzer_messages", "chipTemperature"])
    writer.writerows(zip(times, z, d, h, v, nearest_labels, haptic_messages, buzzer_messages, chipTemperature))
